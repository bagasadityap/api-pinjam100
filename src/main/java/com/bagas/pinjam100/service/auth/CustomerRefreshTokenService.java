...
public class CustomerRefreshTokenService {
    ...
    private final CustomerRefreshTokenRepository repository;
    ...
    public CustomerRefreshToken validate(
            String rawToken
    ) {
    ...
    public RotatedRefreshToken rotate(
        ...
        CustomerRefreshToken oldRefreshToken =
                repository.findByTokenHash(
                        hash(rawToken)
                ).orElseThrow(() ->
                        new AuthenticationException(
